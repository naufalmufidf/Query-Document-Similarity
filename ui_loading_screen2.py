...
################################################################################
## Form generated from reading UI file 'loading_screen2YjgPPm.ui'
##
...
"}")
        ...
        self.label_credits.setGeometry(QRect(10, 340, 181, 31))
        font3 = QFont()
    ...
    def retranslateUi(self, Loading2):
        ...
        self.label_title.setText(QCoreApplication.translate("Loading2", u"<html><head/><body><p>Query<span style=\" font-weight:600;\">-</span>Document Similarity</p></body></html>", None))
        self.label_desc.setText(QCoreApplication.translate("Loading2", u"Menghitung kemiripan beberapa dokumen dengan query", None))
        self.label_loading.setText(QCoreApplication.translate("Loading2", u"loading...", None))
        self.label_credits.setText(QCoreApplication.translate("Loading2", u"Final project by : Naufal Mufid F", None))
    # retranslateUi
